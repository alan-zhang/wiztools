...
2. This application is most useful when hidden behind mod-jk--Apache: for
   super-short URLs. But this is not mandatory.
...
Steps:
  ...
  4. Reload the web-application 'redir'.
  5. Access the URL: http://localhost/redir/r/a.
